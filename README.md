...
* Tue Nov 22 2022 04:28:27 GMT-0800 (PST)
* Source doc: TIBCO SE Activities iPaaS Workshop 2022- V1.3
...
<p style="color: red; font-weight: bold">>>>>>  gd2md-html alert:  ERRORs: 0; WARNINGs: 2; ALERTS: 103.</p>
...
<strong>iPaaS Workshop</strong></p>
...
4. After this, you should see a landing page which looks similar to this:
...
![alt_text](images/image16.jpg "image_tooltip")
    ...
    Click on the orange **Generate Schema** button, and replace  \
**GiveNewSchemaNameHere** by **salesOrderSyncResponse** in the next form.  \
The form should look something like this:
...
<p id="gdcalert26" ><span style="color: red; font-weight: bold">>>>>>  gd2md-html alert: inline image link here (to images/image25.jpg). Store image on your image server and adjust path/filename/extension if necessary. </span><br>(<a href="#">Back to top</a>)(<a href="#gdcalert27">Next alert</a>)<br><span style="color: red; font-weight: bold">>>>>> </span></p>
...
<p id="gdcalert27" ><span style="color: red; font-weight: bold">>>>>>  gd2md-html alert: inline image link here (to images/image26.jpg). Store image on your image server and adjust path/filename/extension if necessary. </span><br>(<a href="#">Back to top</a>)(<a href="#gdcalert28">Next alert</a>)<br><span style="color: red; font-weight: bold">>>>>> </span></p>
...
![alt_text](images/image26.jpg "image_tooltip")
    ...
    and select the following files from the github  /[api_specs](https://github.com/MLEIJDEK/tciworkshop/tree/master/src/api_specs)/ directory:
...
<p id="gdcalert28" ><span style="color: red; font-weight: bold">>>>>>  gd2md-html alert: inline image link here (to images/image27.jpg). Store image on your image server and adjust path/filename/extension if necessary. </span><br>(<a href="#">Back to top</a>)(<a href="#gdcalert29">Next alert</a>)<br><span style="color: red; font-weight: bold">>>>>> </span></p>


![alt_text](images/image27.jpg "image_tooltip")


4. For the SAPHanaPurchaseOrders we also create a Mock application as we did in 2.2.2.
...
Service
  ...
  <tr>
   ...
   <td><a href="https://github.com/MLEIJDEK/tciworkshop/tree/master/src/bw_projects/SalesForceAPI_1.0.0/">SalesForceAPI_1.0.0.ear + manifest.json</a>
   </td>
  </tr>
  <tr>
   <td>Orders Service
   </td>
   <td><a href="https://github.com/MLEIJDEK/tciworkshop/tree/master/src/bw_projects/SAPOrdersAPI_1.0.0/">SAPOrdersAPI_1.0.0.ear + manifest.json</a>
   </td>
  </tr>
  <tr>
   <td>Sales Order Service (stub via API Mock)
   </td>
   <td><a href="https://github.com/MLEIJDEK/tciworkshop/tree/master/src/bw_projects/SAPHanaAPI_1.0.0/">SAPHanaAPI_1.0.0.ear + manifest.json</a>
   </td>
  </tr>
</table>
...
6. When the Business Works integrations are running, we need to set the endpoint visibility to limit it from public to Tibco Cloud Mesh.
...
3. Click on the **Import OpenAPI spec** button, to generate the skeleton. \
After generation, your screen should look like this.
...
4. Click on the “New_Flogo_App_0” name of the integration and rename it to “**salesorders_1_0_flogo_app**”.
...
![drawing](https://docs.google.com/drawings/d/12345/export/png)
2. To enable data to flow between the trigger and the flow, you first need to map the trigger output to the flow input, and flow data to the trigger reply. Click on the 

<p id="gdcalert47" ><span style="color: red; font-weight: bold">>>>>>  gd2md-html alert: inline image link here (to images/image45.jpg). Store image on your image server and adjust path/filename/extension if necessary. </span><br>(<a href="#">Back to top</a>)(<a href="#gdcalert48">Next alert</a>)<br><span style="color: red; font-weight: bold">>>>>> </span></p>


![alt_text](images/image45.jpg "image_tooltip")
 icon to open the configuration of the **ReceiveHTTPMessage** trigger.
3. Check the auto mapped mappings from the trigger output to the flow input as follows:

    

<p id="gdcalert48" ><span style="color: red; font-weight: bold">>>>>>  gd2md-html alert: inline image link here (to images/image46.jpg). Store image on your image server and adjust path/filename/extension if necessary. </span><br>(<a href="#">Back to top</a>)(<a href="#gdcalert49">Next alert</a>)<br><span style="color: red; font-weight: bold">>>>>> </span></p>


![alt_text](images/image46.jpg "image_tooltip")


4. Also check the mapping of the flow data to the trigger reply as follows:

    

<p id="gdcalert49" ><span style="color: red; font-weight: bold">>>>>>  gd2md-html alert: inline image link here (to images/image47.jpg). Store image on your image server and adjust path/filename/extension if necessary. </span><br>(<a href="#">Back to top</a>)(<a href="#gdcalert50">Next alert</a>)<br><span style="color: red; font-weight: bold">>>>>> </span></p>


![alt_text](images/image47.jpg "image_tooltip")


5. Close the trigger configuration screen, and move the **ConfigureHTTPResponse** and **Return** tiles at least 3 positions to the right.  \
...
2. Configure this activity as follows:
...
Activity Input
  ...
  <tr>
   <td><code>pathParams.orderId</code>
   </td>
   <td><code>$flow.pathParams.orderId</code>
   </td>
  </tr>
</table>
...
3. Close the activity configuration screen, the integration should now look like the picture below.
...
4. Now create a second activity, by clicking on the next `+` and navigate through **General > Invoke REST Service**. Configure this activity as follows:
...
Activity Input
  ...
  <tr>
   <td><code>queryParams.firstName</code>
   </td>
   <td><code>string.substringBefore($activity[GetPurchaseOrder].responseCodes["200"].d.PurchaseOrderByCustomer, "::")</code>
   </td>
  </tr>
  <tr>
   <td><code>queryParams.lastName</code>
   </td>
   <td><code>string.substringBefore(string.substringAfter($activity[GetPurchaseOrder].responseCodes["200"].d.PurchaseOrderByCustomer, "::"), "::")</code>
   </td>
  </tr>
  <tr>
   <td><code>queryParams.email</code>
   </td>
   <td><code>string.substringAfter(string.substringAfter($activity[GetPurchaseOrder].responseCodes["200"].d.PurchaseOrderByCustomer, "::"), "::")</code>
   </td>
  </tr>
</table>
    ...
    * The first mapping we will create manually using the Function wizard. \
        ...
        1. Select the _Activity Input_ : **queryParams.firstName **and click on the Functions button. \
 \
...
![alt_text](images/image57.png "image_tooltip")
 \
        ...
        3. Set the first string **_str_** parameter to the PurchaseOrderByCustomer field from the responsebody of the GetPurchaseOrder Activity. \
...
![alt_text](images/image58.png "image_tooltip")
 \
        ...
        4. Set the second string **_beforestr_** to **"::", **by typing into the mapping.
...
5. Close the activity configuration screen, the integration flow now should look like this \
 \
...
6. Now we create the third activity, which corresponds to the SAP Order Creation Service. Click on the next `+` and navigate through **General > Invoke REST Service**. Configure this activity as follows:
...
Activity Input
  ...
  <tr>
   <td><code>body.Email</code>
   </td>
   <td><code>$activity[GetContacts].responseCodes["200"].email</code>
   </td>
  </tr>
  <tr>
   <td><code>body.firstName</code>
   </td>
   <td><code>$activity[GetContacts].responseCodes["200"].firstName</code>
   </td>
  </tr>
  <tr>
   <td><code>body.item</code>
   </td>
   <td><code>"1"</code>
   </td>
  </tr>
  <tr>
   <td><code>body.lastName</code>
   </td>
   <td><code>$activity[GetContacts].responseCodes["200"].lastName</code>
   </td>
  </tr>
  <tr>
   <td><code>body.phone</code>
   </td>
   <td><code>$activity[GetContacts].responseCodes["200"].mobile</code>
   </td>
  </tr>
  <tr>
   <td><code>body.price</code>
   </td>
   <td><code>$activity[GetPurchaseOrder].responseCodes["200"].d.TotalNetAmount</code>
   </td>
  </tr>
</table>
...
7. Close the activity configuration screen. The flow now looks similar to the following picture. \
 \
...
8. Now configure the **ConfigureHTTPResponse** activity as follows:
    * In the **Input** section, create the following mapping:
...
Activity Input
  ...
  <tr>
   <td><code>Input.body._response_string</code>
   </td>
   <td><code>$activity[PostSalesOrder].responseCodes["200"]._response_string</code>
   </td>
  </tr>
</table>
...
9. Close the activity configuration screen. 
10. Now Validate the Integration, the result should look something like:
...
1. Click on the Blue **Test** Button to start the Test configuration wizard. \
First you need to create a Launch Configuration for this test. \
 \
...
2. Click on the corresponding tile and give your configuration a name. \
Create a mapping for the integration input parameter **orderId** as shown below.
...
4. Click on the green POST operation to open the API details. \
 \
...
5. Test the **salesorders_1_0_flogo_app** app by clicking on the **Try it out!** button. \
Fill out a value in the **orderId** field, and click on the blue Execute bar. Now watch the result. \
 \
...
_Figure 1: Push App Button_



3. On clicking the Push App button, select the Decision Service tab in the wizard shown below. 
4. Select the desired Application Size, No.of Instances and the Name of the Application before pushing the application using the Push button.
...
_Figure 2: SDS - Push Application_
...
_Figure 3: Application Push Stages_
...
_Figure 4: Application Deployment_



2. Now the base TCE project to create a SDS is available and deployed. Let's proceed ahead to implement a SDS now. 
...
<p id="gdcalert83" ><span style="color: red; font-weight: bold">>>>>>  gd2md-html alert: inline image link here (to images/image81.jpg). Store image on your image server and adjust path/filename/extension if necessary. </span><br>(<a href="#">Back to top</a>)(<a href="#gdcalert84">Next alert</a>)<br><span style="color: red; font-weight: bold">>>>>> </span></p>


![alt_text](images/image81.jpg "image_tooltip")


_Figure 5: TIBCO Cloud Events Home - WebStudio option_
...
<p id="gdcalert84" ><span style="color: red; font-weight: bold">>>>>>  gd2md-html alert: inline image link here (to images/image82.jpg). Store image on your image server and adjust path/filename/extension if necessary. </span><br>(<a href="#">Back to top</a>)(<a href="#gdcalert85">Next alert</a>)<br><span style="color: red; font-weight: bold">>>>>> </span></p>


![alt_text](images/image82.jpg "image_tooltip")


_Figure 6: Create a new Decision Service option_
...
_Figure 7: Create Decision Service wizard_
...
_Figure 8: Input fields of SDS_
...
_Figure 9: Output fields of SDS_
...
<p id="gdcalert88" ><span style="color: red; font-weight: bold">>>>>>  gd2md-html alert: inline image link here (to images/image86.jpg). Store image on your image server and adjust path/filename/extension if necessary. </span><br>(<a href="#">Back to top</a>)(<a href="#gdcalert89">Next alert</a>)<br><span style="color: red; font-weight: bold">>>>>> </span></p>


![alt_text](images/image86.jpg "image_tooltip")


_Figure 10: Decision Service Implementation_
...
_Figure 11: Deployment Dashboard_
...
_Figure 12: Generate Deployable_
...
_Figure 13: Home page - view Endpoints option_
...
Assuming you start with a clean enviroment, your screen should look similar to this:



<p id="gdcalert95" ><span style="color: red; font-weight: bold">>>>>>  gd2md-html alert: inline image link here (to images/image93.jpg). Store image on your image server and adjust path/filename/extension if necessary. </span><br>(<a href="#">Back to top</a>)(<a href="#gdcalert96">Next alert</a>)<br><span style="color: red; font-weight: bold">>>>>> </span></p>


![alt_text](images/image93.jpg "image_tooltip")
...
<p id="gdcalert96" ><span style="color: red; font-weight: bold">>>>>>  gd2md-html alert: inline image link here (to images/image94.jpg). Store image on your image server and adjust path/filename/extension if necessary. </span><br>(<a href="#">Back to top</a>)(<a href="#gdcalert97">Next alert</a>)<br><span style="color: red; font-weight: bold">>>>>> </span></p>


![alt_text](images/image94.jpg "image_tooltip")
...
Field
  ...
  <tr>
   ...
   <td><code>https://integration.cloud.tibco.com:443</code>
   </td>
  </tr>
  <tr>
   <td>Username
   </td>
   <td><code>your@email.com</code>
   </td>
  </tr>
  <tr>
   <td>Password
...
<p id="gdcalert97" ><span style="color: red; font-weight: bold">>>>>>  gd2md-html alert: inline image link here (to images/image95.jpg). Store image on your image server and adjust path/filename/extension if necessary. </span><br>(<a href="#">Back to top</a>)(<a href="#gdcalert98">Next alert</a>)<br><span style="color: red; font-weight: bold">>>>>> </span></p>


![alt_text](images/image95.jpg "image_tooltip")


4. Click the **Finish** button when your done done, and click the **Close** button in the **Configure API Settings** form. The API Explorer should look like this:

    

<p id="gdcalert98" ><span style="color: red; font-weight: bold">>>>>>  gd2md-html alert: inline image link here (to images/image96.jpg). Store image on your image server and adjust path/filename/extension if necessary. </span><br>(<a href="#">Back to top</a>)(<a href="#gdcalert99">Next alert</a>)<br><span style="color: red; font-weight: bold">>>>>> </span></p>


![alt_text](images/image96.jpg "image_tooltip")
...
2. Select the <code>[tci_workshop_stubs.zip](https://github.com/TIBCONL/tciworkshop/blob/master/src/bw_projects/tci_workshop_stubs.zip)</code> file from the <code>[src/bw_projects](https://github.com/TIBCONL/tciworkshop/blob/master/src/bw_projects)</code> directory. Your screen should look like this:

    

<p id="gdcalert99" ><span style="color: red; font-weight: bold">>>>>>  gd2md-html alert: inline image link here (to images/image97.jpg). Store image on your image server and adjust path/filename/extension if necessary. </span><br>(<a href="#">Back to top</a>)(<a href="#gdcalert100">Next alert</a>)<br><span style="color: red; font-weight: bold">>>>>> </span></p>
...
<p id="gdcalert100" ><span style="color: red; font-weight: bold">>>>>>  gd2md-html alert: inline image link here (to images/image98.jpg). Store image on your image server and adjust path/filename/extension if necessary. </span><br>(<a href="#">Back to top</a>)(<a href="#gdcalert101">Next alert</a>)<br><span style="color: red; font-weight: bold">>>>>> </span></p>
...
<p id="gdcalert101" ><span style="color: red; font-weight: bold">>>>>>  gd2md-html alert: inline image link here (to images/image99.jpg). Store image on your image server and adjust path/filename/extension if necessary. </span><br>(<a href="#">Back to top</a>)(<a href="#gdcalert102">Next alert</a>)<br><span style="color: red; font-weight: bold">>>>>> </span></p>
...
<p id="gdcalert102" ><span style="color: red; font-weight: bold">>>>>>  gd2md-html alert: inline image link here (to images/image100.jpg). Store image on your image server and adjust path/filename/extension if necessary. </span><br>(<a href="#">Back to top</a>)(<a href="#gdcalert103">Next alert</a>)<br><span style="color: red; font-weight: bold">>>>>> </span></p>


![alt_text](images/image100.jpg "image_tooltip")
...
<p id="gdcalert103" ><span style="color: red; font-weight: bold">>>>>>  gd2md-html alert: inline image link here (to images/image101.jpg). Store image on your image server and adjust path/filename/extension if necessary. </span><br>(<a href="#">Back to top</a>)(<a href="#gdcalert104">Next alert</a>)<br><span style="color: red; font-weight: bold">>>>>> </span></p>


![alt_text](images/image101.jpg "image_tooltip")
